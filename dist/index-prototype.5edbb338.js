...
Slider.prototype.move = function (direction) {
  ...
  if (direction === "back") {
    ...
    var _ref2 = [this.current, this.next, // get the next slide, or if its at the end, loop around and grab the first slide
...
console.log(mySlider, dogSlider); // Add a keyup listener to dogslider
// access dog slider as global variable

window.dogSlider = dogSlider; // functionality is now exposed via prototype methods so this can now be hooked into to create custom functionality like below.
...
},{}]},{},["../../../.npm-global/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index-prototype.js"], null)
